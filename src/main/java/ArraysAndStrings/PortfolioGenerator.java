...
public class PortfolioGenerator {
    ...
    public static void main(String[] args) {
        ...
        for (int portfolioId = 1; portfolioId <= numPortfolios; portfolioId++) {
            ...
            portfolio.put("snapshotType", snapshotType);
            ...
            for (int positionId = 1; positionId <= positionCount; positionId++) {
                ...
                position.put("id", positionIdPrefix + "pos" + positionId);
                position.put("quantity", getRandomInt(0, 1000));
                position.put("quantityType", "NumShares");
                position.put("baseMarketValue", baseCurrency + " " + String.format("%.2f", getRandomInt(0, 50000) / 100.0));
                position.put("localMarketValue", localCurrency + " " + String.format("%.2f", getRandomInt(0, 50000) / 100.0));

                Map<String, Object> instrument = new HashMap<>();
                Map<String, Object> primaryId = new HashMap<>();
                primaryId.put("id", instrumentId);
